...
class TestWorksheetAnalyzer:
    ...
    def test_analyze_worksheet(self) -> None:
        ...
        cell3 = Cell(
            address="B2", row=2, column=2, value=30, data_type="n", locked=False
        )
    ...
    def test_detect_data_region(self) -> None:
        ...
        min_row, min_col, max_row, max_col = (
            WorksheetAnalyzer.detect_data_region(worksheet)
        )
    ...
    def test_get_editable_cells(self) -> None:
        ...
        editable = Cell(
            address="A1", row=1, column=1, value="Edit", locked=False
        )
        locked = Cell(
            address="A2", row=2, column=1, value="No Edit", locked=True
        )
    ...
    def test_get_formula_cells(self) -> None:
        ...
        formula_cell = Cell(
            address="A1", row=1, column=1, formula="=B1+B2", value=10
        )
